...
Background: questions in database
  ...
  | Question A  |           |           |           | A      | Python          | control flow | flash card     |
  | Question B  |           |           |           | B      | Python          | control flow | flash card     |
  | Question C  |           |           |           | C      | Python          | control flow | flash card     |
  | Question D  |           |           |           | D      | Python          | control flow | flash card     |
  | Question E  |           |           |           | E      | Python          | control flow | flash card     |
